...
namespace SalesCore.Infrastructure.Migrations
{
    ...
    [Migration("20221206114148_adddefaultdataincontracttable")]
    partial class adddefaultdataincontracttable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CarSales.Core.Models.InsuranceContract", b =>
                {
                    ...
                    b.Property<DateTime>("InsuranceDate")
                        ...
                        .HasDefaultValue(new DateTime(2022, 12, 6, 13, 41, 48, 565, DateTimeKind.Local).AddTicks(4431));
